...
export const socialNetworks = [
  {
    ...
    src: 'https://www.linkedin.com/in/dev-tuna/',
  },
  {
    id: 2,
    logo: <Github size={30} strokeWidth={1} />,
    src: 'https://github.com/iamtun',
  },
  {
    id: 3,
    logo: <Facebook size={30} strokeWidth={1} />,
    src: 'https://www.facebook.com/2001tun/',
  },
  {
    id: 4,
    logo: <Unplug size={30} strokeWidth={1} />,
    src: 'https://www.tiktok.com/@tuna.dev',
  },
];
